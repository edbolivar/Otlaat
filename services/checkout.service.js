...
(function () {
    ...
    CheckoutService.$inject = ['$http', 'constants', 'authService', '$uibModal', 'modalsStackService'];

    function CheckoutService($http, constants, authService, $uibModal, modalsStackService) {
        var userData="";
        var otherDtls="";
        return {
        ...
        function open(size, parentSelector, animationsEnabled, items){
            ...
            var modalInstance = $uibModal.open({
                ...
                templateUrl: 'templates/modal/checkoutPopup.html',
        ...
        function getOrderDetails(options, token) {
            ...
            payload.token = token;
            roomsString += 'token=' + payload.token;
        ...
        function checkoutPay(payload){ //console.log('patload checkout', payload);
             return $http.post(constants.requestUrls.checkoutPay, payload);
        }
